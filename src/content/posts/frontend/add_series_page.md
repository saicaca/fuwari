...
> 接上回 [在博客中添加系列栏](/posts/frontend/add_series_field/)<br>
            ...
            <div>
                <div class="flex flex-row w-full items-center h-[3.75rem]">
                    <a aria-label={group.category} href={getCategoryUrl(group.category)}
                            class="btn-plain scale-animation rounded-lg h-11 active:scale-95 w-[17%] md:w-[12%] transition text-2xl font-bold text-75"
                    >
                      <div class="flex items-center">
                          {group.category}
                      </div>
                    </a>
                    {/* <div class="w-[15%] md:w-[10%] transition text-2xl font-bold text-right text-75">{group.category}</div> */}
                    <div class="w-[15%] md:w-[10%]">
                        <div class="h-3 w-3 bg-none rounded-full outline outline-[var(--primary)] mx-auto -outline-offset-[2px] z-50 outline-3"></div>
                    </div>
                    <div class="w-[68%] md:w-[78%] transition text-left text-50">{group.series.length} 个{i18n(I18nKey.series)}</div>
                </div>
