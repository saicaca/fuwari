...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    ...
    credit: {
      ...
      text: 'By 水澄ぐみ',              // Credit text to be displayed
      url: 'https://www.pixiv.net/artworks/115563367'                // (Optional) URL link to the original artwork or artist's page
    }
  },
  toc: {
  ...
  favicon: [    // Leave this array empty to use the default favicon
    {
      src: '/favicon/icons8-羽毛笔-64.png',    // Path of the favicon, relative to the /public directory
