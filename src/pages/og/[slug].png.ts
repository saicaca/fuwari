            ...
            children: [
              {
                ...
                props: {
                  ...
                  children: [
                    { type: "img", props: { src: avatarBase64, width: 60, height: 60, style: { borderRadius: "50%" } } },
                    { type: "div", props: { style: { fontSize: "28px", fontWeight: 600, color: textColor }, children: profileConfig.name } },
                  ],
                },
              },
              { type: "div", props: { style: { fontSize: "28px", color: subtleTextColor }, children: pubDate } },
            ],
          },
        },
      ],
